...
<body>
		...
		<div class="container-fluid">
			<a class="navbar-brand" href="/fireworks" style="color:#ffffff;"><i class="fa fa-shopping-bag"></i> &nbsp;4Alphas</a> &nbsp;<label style="font-size:12px;"> Welcome <%=((User)(SecurityContextHolder.getContext().getAuthentication().getPrincipal())).getUsername()%></label>
	<!-- 		<button class="navbar-toggler navbar-toggler-right" type="button"
			...
			<div class="collapse navbar-collapse" id="navbarResponsive" >
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="/firesupport/invoice/stock" style="color:#ffffff;"><i class="fa fa-suitcase"></i>&nbsp;Inventory</a></li>
				...
				<li class="nav-item"><a class="nav-link js-scroll-trigger"
					...
					<li class="nav-item"><a class="nav-link js-scroll-trigger"
						href="/firesupport/invoice/search/display" style="color:#ffffff;"><i class="fa fa-bullhorn"></i>&nbsp;Invoices</a></li>
				</ul>
			</div>
		</div>
	</nav> 
